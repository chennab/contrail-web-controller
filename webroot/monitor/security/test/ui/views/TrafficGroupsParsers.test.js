...
define([
	...
	test("passe-and-sort-firewall-policy-details", function() {
	    var dataObj = TGMockData.getFRuleDetails,
	        result = tgHelpers.parseAndSortPolicyDetailObj(dataObj.data, [], ruleUUIDs)
	                           .formattedRuleDetails;
	    console.log('Executng parse-and-sort-firewall-policy-details...');
	    equal(JSON.stringify(result), JSON.stringify(dataObj.expected));
	});
});
