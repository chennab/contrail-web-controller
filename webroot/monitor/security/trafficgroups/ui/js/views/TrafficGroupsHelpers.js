...
define([
    ...
    var trafficGroupsHelpers = function() {
            ...
            var self = this,
                ...
                remote: {
                    ...
                    dataParser: function (data) {
                        ...
                        policyObj = self.getAndSortAppAPS(apsDetails, project, domain, reqObj.app);
                    }
                },
                vlRemoteConfig: {
                    vlRemoteList: [{
        ...
        this.getTabsViewConfig = function (elementId) {
            return {
                    ...
                    rows: [{
                        columns: [{
                            ...
                            viewConfig: {
                                theme: 'default',
                                active: 0,
                                tabs: this.getTabsContentConfig()
                            }
                        }]
                    }]
                }
        ...
        this.getTabsContentConfig = function() {
            var self = this,
                tabConfig = [];
            tabConfig.push({
                elementId: "tg_workloads",
                title: 'Workloads',
                view: "TextView",
        ...
        this.getAndSortAppAPS = function(apsDetails, project, domain, app) {
            var policyObj = [];
            ...
            var curAppGlobalAPS = _.filter(apsDetails, function(aps) {
                var curAps = _.result(aps, 'application-policy-set', {}),
                    tagAPS = _.filter(curAps.tag_refs, function(tagRef) {
                        var istagRef = app == 'all' ? tagRef.to
                                    : (tagRef.to && (tagRef.to.join(':') == app));
                        return ((curAps.fq_name[0] == 'default-policy-management')
                               && istagRef);
                    });
            ...
            $.each(ruleObj.ruleDetails, function (idx, detailsObj) {
                if (detailsObj['firewall-rule'] != null) {
                    ...
                    ruleObj.formattedRuleDetails.push({
                        ...
                        rule_name: rule_name,
                        implicitRule: '',
                        isMatchedRule: $.inArray(ruleUUID,ruleObj.matchedRuleUUIDs) > -1,
                        srcId: ruleObj.srcId,
